...
const AMMESSI = {
  'app.js': {
    perche: 'messaggi che il bot scrive in chat, simboli dei rulli della slot, le didascalie che lo streamer incolla sui social, le faccine della prima schermata di Discord nella prova del pannello, e il pescato e le frasi di serie dei giochi nella copia della demo delle regole (sono quello che il bot scrive in chat, e lo streamer le modifica li\')',
    segni: '🎮👉🔴🗓️💜😂😱🤬😭😨🤢🎰🍀💸🎁🕵️🚨💰✨💀🍒⭐💎🔥🎲❓🥿🥫🐟🦀🐙🗡️👢🧰🥊😄',
  },
  'tracking-games.js': {
