...
export const COMANDI = [
  ...
  { id: 'cinque', modulo: 'giochi', nomi: ['cinque', 'highfive', 'hi5'], titolo: ['Batti il cinque', 'High five', 'Choca esos cinco'],
    cosa: ['Alza la mano per qualcuno (!cinque @nome) o per chiunque: chi risponde al volo con !cinque fa il cinque perfetto, e l\'overlay lo fa vedere e sentire.', 'Raise your hand for someone (!cinque @nome) or anyone: whoever answers !cinque right away makes the perfect high five, and the overlay shows and plays it.', 'Levanta la mano para alguien (!cinque @nome) o para cualquiera: quien responde !cinque al vuelo hace el cinco perfecto, y el overlay lo muestra y lo suena.'] },
