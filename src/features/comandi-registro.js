...
export const COMANDI = [
  ...
  { id: 'blackjack', modulo: 'giochi', gioco: 'blackjack', nomi: ['blackjack', 'bj', '21'], titolo: ['Blackjack', 'Blackjack', 'Blackjack'],
    cosa: ['Una mano di blackjack contro il banco: !bj 50, poi !carta o !stai. Il banco sta su ogni 17, il blackjack servito paga 3 a 2.', 'A hand of blackjack against the dealer: !bj 50, then !carta or !stai. The dealer stands on every 17, a dealt blackjack pays 3 to 2.', 'Una mano de blackjack contra la banca: !bj 50, luego !carta o !stai. La banca se planta en cada 17, el blackjack servido paga 3 a 2.'], costa: true },
  { id: 'carta', modulo: 'giochi', nomi: ['carta'], titolo: ['Carta', 'Hit', 'Carta'],
  ...
  { id: 'passa', modulo: 'giochi', nomi: ['passa', 'pass'], titolo: ['Passa', 'Pass', 'Pasa'],
    cosa: ['Passi la patata bollente: !passa @nome, o !passa e va a qualcuno a caso.', 'You pass the hot potato: !passa @name, or !passa and it goes to someone at random.', 'Pasas la patata caliente: !passa @nombre, o !passa y va a alguien al azar.'] },
  { id: 'catena', modulo: 'giochi', gioco: 'catena', nomi: ['catena', 'parole'], titolo: ['Catena di parole', 'Word chain', 'Cadena de palabras'],
    cosa: ['Apre la catena di parole: ogni parola comincia con le ultime due lettere della precedente. Si batte il record del canale.', 'Opens the word chain: each word starts with the last two letters of the previous one. You beat the channel record.', 'Abre la cadena de palabras: cada palabra empieza con las dos últimas letras de la anterior. Se bate el récord del canal.'] },
