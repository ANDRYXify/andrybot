...
export default {
  ...
  corpo: [
    ...
    { tabella: [
      ...
      ['Davanti e dietro', 'Nei <strong>livelli</strong> in cima c\'è quello in primo piano. Trascina una riga dalla presa, i sei puntini a sinistra: più su va davanti, più giù va dietro, e la tela lo segue mentre la muovi. Da tastiera <strong>Alt+↑</strong> e <strong>Alt+↓</strong> (con <strong>Maiusc</strong> fino in cima o in fondo), oppure <strong>Ctrl+]</strong> e <strong>Ctrl+[</strong>, o «Davanti» e «Dietro» nelle proprietà. Scegliere un elemento non lo porta davanti: le maniglie stanno sopra a tutto. In diretta l\'ordine è lo stesso della tela, ed è di ogni overlay.'],
