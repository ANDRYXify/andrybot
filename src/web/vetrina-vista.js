...
const CAPACITA = [
  ...
  { ico: '<path d="M11 6a13 13 0 0 0 8.4-2.8A1 1 0 0 1 21 4v12a1 1 0 0 1-1.6.8A13 13 0 0 0 11 14H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2z"/><path d="M6 14a12 12 0 0 0 2.4 7.2 2 2 0 0 0 3.2-2.4A8 8 0 0 1 10 14"/>', area: ['Farti trovare', 'Getting you found', 'Que te encuentren'], voci: [
    ...
    { scheda: 'notifiche', pacc: 'notifiche', t: ['Bot su Telegram', 'Telegram bot', 'Bot en Telegram'], d: ['Gestisci il bot dal telefono, fai gli auguri di compleanno al gruppo e a fine diretta ricevi in privato il rapporto della serata.', 'Manage the bot from your phone, send birthday wishes to the group and get the night’s report in private when the stream ends.', 'Gestiona el bot desde el móvil, felicita los cumpleaños al grupo y al final del directo recibe en privado el informe de la noche.'] },
