...
const CAPACITA = [
  ...
  { ico: '<rect x="2" y="4" width="20" height="13" rx="2"/><path d="M8 21h8"/><path d="M12 17v4"/>', area: ['Overlay per la diretta', 'stream overlay', 'Overlay para el directo'], voci: [
    ...
    { scheda: 'alert', pacc: 'free', t: ['Player musica su misura', 'Music player, your way', 'Reproductor a tu medida'], d: ['Copertina, righe, tempi, barra e onde: ogni pezzo con la sua misura e il suo colore. Sei temi che si muovono ed entrano ed escono come l\'oggetto vero: il vinile frena e rientra nella custodia, il CD chiude la custodia, la cassetta viene espulsa. Uguale in anteprima e in diretta.', 'Cover, lines, times, bar and waves: each part with its own size and colour. Six themes that move, and come and go like the real object: the vinyl brakes and slides back into its sleeve, the CD closes its case, the cassette is ejected. The same in the preview and on air.', 'Portada, líneas, tiempos, barra y ondas: cada pieza con su medida y su color. Seis temas que se mueven y entran y salen como el objeto real: el vinilo frena y vuelve a su funda, el CD cierra su caja, el casete se expulsa. Igual en la vista previa y en directo.'] },
