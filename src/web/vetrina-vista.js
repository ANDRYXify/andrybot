...
const CAPACITA = [
  ...
  { ico: '<rect x="2" y="4" width="20" height="13" rx="2"/><path d="M8 21h8"/><path d="M12 17v4"/>', area: ['Overlay per la diretta', 'stream overlay', 'Overlay para el directo'], voci: [
    { scheda: 'alert', pacc: 'free', t: ['Overlay Studio', 'Overlay Studio', 'Overlay Studio'], d: ['Chat a schermo, widget e temi: colori, font, posizione e dimensione, con livelli che si bloccano, guide e zoom. Più overlay, ognuno col suo link segreto, che rinnovi con un tasto se ti scappa.', 'On-screen chat, widgets and themes: colours, fonts, position and size, with lockable layers, guides and zoom. Multiple overlays, each with its own secret link, renewed with one key if it leaks.', 'Chat en pantalla, widgets y temas: colores, fuentes, posición y tamaño, con capas que se bloquean, guías y zoom. Varios overlays, cada uno con su enlace secreto, que renuevas con una tecla si se te escapa.'] },
