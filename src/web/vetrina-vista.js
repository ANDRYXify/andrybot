...
const CAPACITA = [
  ...
  { ico: '<rect x="2" y="4" width="20" height="13" rx="2"/><path d="M8 21h8"/><path d="M12 17v4"/>', area: ['Overlay per la diretta', 'stream overlay', 'Overlay para el directo'], voci: [
    ...
    { scheda: 'alert', pacc: 'musica', t: ['Player musica su misura', 'Music player, your way', 'Reproductor a tu medida'], d: ['Copertina, righe, tempi, barra e onde: ogni pezzo con la sua misura e il suo colore. Temi con la loro animazione: vinile, CD, cassetta, terminale, manga, esagono. Uguale in anteprima e in diretta.', 'Cover, lines, times, bar and waves: each part with its own size and colour. Themes with their own motion: vinyl, CD, cassette, terminal, manga, hexagon. The same in the preview and on air.', 'Portada, líneas, tiempos, barra y ondas: cada pieza con su medida y su color. Temas con su propia animación: vinilo, CD, casete, terminal, manga, hexágono. Igual en la vista previa y en directo.'] },
