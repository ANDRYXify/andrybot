...
const CAPACITA = [
  { ico: '<path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/>', area: ['Chat e comandi', 'Chat and commands', 'Chat y comandos'], voci: [
    ...
    { scheda: 'personalita', pacc: 'free', t: ['Personalità e tono', 'Personality and tone', 'Personalidad y tono'], d: ['Decidi come parla e quanto interviene da solo in chat, e vedi cosa ha detto di sua iniziativa, con l’ora e il motivo.', 'You decide how it speaks and how often it chimes in, and you see what it said on its own, with time and reason.', 'Decides cómo habla y cuánto interviene solo en el chat, y ves qué dijo por su cuenta, con la hora y el motivo.'] },
