...
const CAPACITA = [
  ...
  { ico: '<rect x="2" y="4" width="20" height="13" rx="2"/><path d="M8 21h8"/><path d="M12 17v4"/>', area: ['Overlay per la diretta', 'stream overlay', 'Overlay para el directo'], voci: [
    ...
    { scheda: 'alert', pacc: 'free', t: ['Hype train a schermo', 'Hype train on screen', 'Hype train en pantalla'], d: ['Livello, barra, quanto manca e chi sta spingendo di più, presi da Twitch mentre il treno corre. E in chat il bot lo dice quando parte, quando sale di livello e quando finisce.', 'Level, bar, time left and who is pushing the hardest, taken from Twitch while the train runs. And in chat the bot says it when it starts, when it levels up and when it ends.', 'Nivel, barra, lo que falta y quién empuja más, tomados de Twitch mientras el tren corre. Y en el chat el bot lo dice cuando sale, cuando sube de nivel y cuando acaba.'] },
