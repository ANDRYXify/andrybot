...
const CAPACITA = [
  ...
  { ico: '<rect x="2" y="4" width="20" height="13" rx="2"/><path d="M8 21h8"/><path d="M12 17v4"/>', area: ['Overlay per la diretta', 'stream overlay', 'Overlay para el directo'], voci: [
    ...
    { scheda: 'alert', pacc: 'free', t: ['Player musica su misura', 'Music player, your way', 'Reproductor a tu medida'], d: ['Copertina, righe, tempi, barra e onde: ogni pezzo con la sua misura e il suo colore. Sei temi che si muovono ed entrano ed escono come l\'oggetto vero: il vinile frena e rientra nella custodia, il CD chiude la custodia, la cassetta viene espulsa. E con la disposizione libera trascini ogni pezzo dove vuoi. Uguale in anteprima e in diretta.', 'Cover, lines, times, bar and waves: each part with its own size and colour. Six themes that move, and come and go like the real object: the vinyl brakes and slides back into its sleeve, the CD closes its case, the cassette is ejected. With the free layout you drag each part where you want it. The same in the preview and on air.', 'Portada, líneas, tiempos, barra y ondas: cada pieza con su medida y su color. Seis temas que se mueven y entran y salen como el objeto real: el vinilo frena y vuelve a su funda, el CD cierra su caja, el casete se expulsa. Con la disposición libre arrastras cada pieza donde quieras. Igual en la vista previa y en directo.'] },
  ...
  { ico: '<path d="M11 6a13 13 0 0 0 8.4-2.8A1 1 0 0 1 21 4v12a1 1 0 0 1-1.6.8A13 13 0 0 0 11 14H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2z"/><path d="M6 14a12 12 0 0 0 2.4 7.2 2 2 0 0 0 3.2-2.4A8 8 0 0 1 10 14"/>', area: ['Farti trovare', 'Getting you found', 'Que te encuentren'], voci: [
    ...
    { scheda: 'pagina', pacc: 'free', t: ['Donazioni e obiettivo in euro', 'Donations and a euro goal', 'Donaciones y objetivo en euros'], d: ['Il tasto «Sostieni» sulla tua pagina link, col tuo tema, verso Ko-fi, PayPal o dove vuoi. Con Ko-fi ogni mancia accende l\'avviso in overlay, il grazie in chat e fa salire un obiettivo in euro, anche sulla pagina.', 'The «Support me» button on your link page, in your theme, pointing to Ko-fi, PayPal or wherever you like. With Ko-fi every tip fires the overlay alert, the thanks in chat, and moves a euro goal, on the page too.', 'El botón «Apóyame» en tu página de enlaces, con tu tema, hacia Ko-fi, PayPal o donde quieras. Con Ko-fi cada propina lanza el aviso en el overlay, el gracias en el chat y sube un objetivo en euros, también en la página.'] },
  ] },
];
