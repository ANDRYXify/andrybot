...
const CAPACITA = [
  ...
  { ico: '<path d="M11 6a13 13 0 0 0 8.4-2.8A1 1 0 0 1 21 4v12a1 1 0 0 1-1.6.8A13 13 0 0 0 11 14H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2z"/><path d="M6 14a12 12 0 0 0 2.4 7.2 2 2 0 0 0 3.2-2.4A8 8 0 0 1 10 14"/>', area: ['Farti trovare', 'Getting you found', 'Que te encuentren'], voci: [
    ...
    { scheda: 'donazioni', pacc: 'free', t: ['Donazioni sul tuo conto', 'Donations on your own account', 'Donaciones en tu propia cuenta'], d: ['Colleghi il tuo conto Stripe o Satispay, tuo e gestito da te, e chi ti segue dona dalla tua pagina link o da una pagina tutta per le donazioni, con le offerte che accendono i tuoi effetti: i soldi arrivano a te, l\'avviso parte in overlay e in chat, e un obiettivo in euro sale anche sulla pagina. Se preferisci Ko-fi o PayPal, il tasto porta lì.', 'Connect your Stripe account once and people donate from your link page: the money goes to you, the alert fires in the overlay and in chat, and a euro goal grows on the page too. If you prefer Ko-fi or PayPal, the button goes there.', 'Conectas tu cuenta de Stripe una vez y quien te sigue dona desde tu página de enlaces: el dinero te llega a ti, el aviso sale en el overlay y en el chat, y un objetivo en euros sube también en la página. Si prefieres Ko-fi o PayPal, el botón lleva allí.'] },
  ] },
];
