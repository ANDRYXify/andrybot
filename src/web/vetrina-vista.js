...
const CAPACITA = [
  ...
  { ico: '<line x1="6" x2="10" y1="11" y2="11"/><line x1="8" x2="8" y1="9" y2="13"/><line x1="15" x2="15.01" y1="12" y2="12"/><line x1="18" x2="18.01" y1="10" y2="10"/><path d="M17.3 5H6.7a4 4 0 0 0-4 3.6C2.6 9.4 2 14.5 2 16a3 3 0 0 0 3 3c1 0 1.5-.5 2-1l1.4-1.4a2 2 0 0 1 1.4-.6h4.4a2 2 0 0 1 1.4.6L17 18c.5.5 1 1 2 1a3 3 0 0 0 3-3c0-1.5-.6-6.6-.7-7.3A4 4 0 0 0 17.3 5z"/>', area: ['Far divertire la chat', 'Entertaining your chat', 'Divertir al chat'], voci: [
    ...
    { scheda: 'giochi', pacc: 'free', t: ['Classifiche e VIP automatico', 'Leaderboards and automatic VIP', 'Clasificaciones y VIP automático'], d: ['Chi partecipa più di tutti sale in classifica e prende il VIP. Scegli tu la gara: le monete del canale o i Bit, e chi guida i Bit tiene la corona in chat fino al premio dopo.', 'Whoever takes part the most climbs the leaderboard and gets VIP. You pick the race: channel coins or Bits, and whoever leads the Bits keeps the crown in chat until the next prize.', 'Quien más participa sube en la clasificación y recibe el VIP. Eliges tú la carrera: las monedas del canal o los Bits, y quien lidera los Bits lleva la corona en el chat hasta el siguiente premio.'] },
