...
export function startWeb({ auth, helix, manager, effects, modules }) {
  ...
  const META_LINGUA = {
    ...
    en: {
      ...
      ogTitolo: 'The Twitch bot that writes with your own account',
      ...
      twTitolo: 'The Twitch bot that writes with your own account',
    ...
    es: {
      ...
      ogTitolo: 'El bot de Twitch que escribe con tu propia cuenta',
      ...
      twTitolo: 'El bot de Twitch que escribe con tu propia cuenta',
