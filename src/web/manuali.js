...
const OVERLAY = {
  ...
  corpo: [
    ...
    { tabella: [
      ...
      ['Onde', 'accese', 'quattro barrette che ballano finché la musica va'],
      ['Sfondo', 'spento', 'la copertina sfocata dietro al player'],
    ...
    { p: ['Il testo è tuo: <code>{titolo}</code> e <code>{artista}</code> vengono sostituiti. E come ogni elemento ha colori, carattere, forma, materia, cornice, dimensione — e lo trascini dove vuoi.'] },
