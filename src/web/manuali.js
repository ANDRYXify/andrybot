...
const VETRINA = {
  ...
  corpo: [
    ...
    { p: ['Vuoi una pagina tutta per le donazioni? Nella scheda Donazioni c\'è <strong>la tua pagina delle donazioni</strong> (<code>dona.socialbot.live/iltuonome</code>, o <code>socialbot.live/dona/iltuonome</code>): stessi strumenti della pagina link (stile, colori, caratteri, blocchi, puntatore), un\'altra pagina. La modifichi dall\'editor della pagina link con l\'interruttore in cima, e sulla pagina link il blocco «Sostieni» può portare lì invece di mostrare il modulo.'] },
