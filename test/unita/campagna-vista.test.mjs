...
import { paginaCampagna } from '../../src/web/campagna-vista.js';
import { CAMPAGNE, finestra } from '../../src/features/campagne.js';
...
test('fuori dai motori, con la sua anteprima e nella lingua della citta\'', () => {
  ...
  for (const [id, h] of [['nyc', nyc], ['milano', mi]]) {
    ...
    assert.match(h, new RegExp(`<meta property="og:image" content="https://socialbot.live/icons/campagna-${id}.png\\?v=1">`));
